...
Zraszacz::Zraszacz(InetHostAddress localIP, InetHostAddress destinationIp, int PortRx, int PortTx)
{
...
void Zraszacz::run(void)
{
	...
	socket->putData(timestamp, salute4,
					strlen((char *)salute4) + 1);
	char tmstring[30];
